package com.pereiraLavaJato.controller;
...
import com.pereiraLavaJato.repository.AgendamentoRepository;
import com.pereiraLavaJato.repository.ProfissionalRepository;
import com.pereiraLavaJato.service.AgendamentoService;
import com.pereiraLavaJato.service.ProfissionalService;
import com.pereiraLavaJato.service.UsuarioService;
    ...
    return usuarioService.autenticar(cpf, senha)
      .map(usuario -> {
        if (usuario.getTipoAcesso() == Usuario.TipoAcesso.admin) {
          ...
          model.addAttribute("profissionais", profissionalRepository.findByAtivoTrue());
